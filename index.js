...
import { buildBaseSystemPrompt } from "./lib/systemPrompt.js";
...
const exampleMessages = structuredVoicePairs.length > 0
  ...
  const systemPrompt = buildBaseSystemPrompt(niche, nicheLabel);
...
// ── ADDITIVE: Public homepage at pay.looped.ltd/home ─────────────────────────
