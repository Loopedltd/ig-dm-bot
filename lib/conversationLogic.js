...
export const SYSTEM_PROMPT_RULES = {
  greetingRule:
    "respond warmly and naturally (\"hey, what's on your mind?\")",
  noRepeatQuestions:
    "never send the same or near-identical question twice in a row",
  conversationHistoryRule:
    "Never ask something they've already told you, in this message or any earlier one.",
  gapAwarenessLongGap:
    "\"long_gap\" (24h+)",
  directProductRequestRule:
    "send it immediately, no extra question first",
  personalQuestionRule:
    "follow the MISSING INFO rule",
  proactiveProductRule:
    "Match products by topic and theme, not just exact keywords",
};
